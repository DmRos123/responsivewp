...
/**
* Template Name: check-output-template
*/
get_header(); ?>
...
<tbody>
  ...
  global $wpdb;
  $result = $wpdb->get_results('SELECT `cannabis_studies` .`study_title`, `type_of_study`, `country_id`, `key_findings`, `chi_rating`, `sub_ratios`, `dosage`, `link_to_study`, `doi`, `year_of_pub`, `cannabis_studies`. `id`
